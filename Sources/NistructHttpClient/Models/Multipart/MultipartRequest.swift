...
public struct MultipartRequest {
    ...
    private func disposition(_ key: String) -> String {
        HttpHeader.ContentDisposition + ": form-data; name=\"\(key)\""
    }
    ...
    public mutating func add(key: String, value: Data) {
    ...
    public mutating func add(key: String, value: AnyObject) {
    ...
    public mutating func add(key: String, fileName: String, fileMimeType: String, fileData: Data) {
        ...
        data.append("\(HttpHeader.ContentType): \(fileMimeType)" + separator + separator)
        data.append(fileData)
        appendSeparator()
    }

    public var httpContentTypeHeadeValue: String {
        ContentType.multipart.rawValue + "; boundary=\(boundary)"
    }
